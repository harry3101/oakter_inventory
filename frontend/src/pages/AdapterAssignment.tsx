...
export default function AdapterAssignment() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success!",
        description: "Adapter assigned successfully.",
      });
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Assign power adapters to employees</p>
      </div>
      
      <Card className="shadow-sm">
        <CardHeader>
          <CardTitle>Adapter Assignment Form</CardTitle>
          <CardDescription>Fill in the details to assign a power adapter to an employee</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-end space-x-2 pt-4">
              ...
              <Button type="submit">Assign Adapter</Button>
            </div>
          </form>
        </CardContent>
      </Card>
