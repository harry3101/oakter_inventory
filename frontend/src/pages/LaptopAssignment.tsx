  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const assignmentData = {
        ...
        status: formState.assetsStatus || 'active',
      ...
      toast({
        title: "Success!",
        description: "Laptop assigned successfully.",
      });
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Assign laptops to employees</p>
      </div>
      
      <Card className="shadow-sm">
        <CardHeader>
          <CardTitle>Laptop Assignment Form</CardTitle>
          <CardDescription>Fill in the details to assign a laptop to an employee</CardDescription>
        </CardHeader>
        <CardContent>
